(() => {
  ...
  const spanish = {
    ...
    "A skincare studio in Dix Hills, New York": "Un estudio de cuidado de la piel en Dix Hills, Nueva York",
    ...
    "683 Old Country Road, Suite 41, in Dix Hills, New York.": "683 Old Country Road, Suite 41, en Dix Hills, Nueva York.",
    ...
    "Does Martha Skin Studio serve clients near Huntington?": "¿Martha Skin Studio atiende a clientes cerca de Huntington?",
    "Yes. The Dix Hills studio welcomes guests from Huntington and nearby Long Island communities.": "Sí. El estudio en Dix Hills recibe a clientes de Huntington y comunidades cercanas de Long Island.",
    "Visit the studio": "Visita el estudio",
    "Quiet care, close to home.": "Cuidado sereno, cerca de ti.",
    "Serving Dix Hills, Huntington, and nearby Long Island communities, including Melville, Commack, Deer Park, and Half Hollow Hills.": "Atendemos a Dix Hills, Huntington y comunidades cercanas de Long Island, incluidas Melville, Commack, Deer Park y Half Hollow Hills.",
    "Get Directions": "Cómo llegar",
    "Personalized skincare in Dix Hills, New York.": "Cuidado personalizado de la piel en Dix Hills, Nueva York.",
    "Care that begins with you.": "Cuidado que comienza contigo.",
    "Explore a considered range of skincare, makeup, and massage experiences at our facial studio in Dix Hills, serving Huntington and nearby Long Island communities.": "Explora una cuidada selección de servicios de piel, maquillaje y masajes en nuestro estudio facial en Dix Hills, que atiende a Huntington y comunidades cercanas de Long Island.",
    ...
    "Guests seeking attentive facials in Dix Hills, NY, with time for a thoughtful conversation.": "Personas que buscan faciales atentos en Dix Hills, NY, con tiempo para una conversación cuidadosa.",
    "What to expect": "Qué puedes esperar",
    ...
    "Personal care in Dix Hills.": "Cuidado personal en Dix Hills.",
    "Welcoming guests from Dix Hills, Huntington, and nearby Long Island communities.": "Recibimos a clientes de Dix Hills, Huntington y comunidades cercanas de Long Island.",
